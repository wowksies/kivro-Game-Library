...
var Storage={};Storage.VERSION=1;Storage.PATH_VERSION='com.martinmagni.pool/version';Storage.PREFIX='com.martinmagni.pool/data/';Storage.LEGACY_PREFIX='/';Storage.stringToHex=function(str){var hex='';for(var i=0;i<str.length;i++){hex+=str.charCodeAt(i).toString(16)+" ";}
return hex;}
...
function pokiSendLevelData(){navigator.sendBeacon('https://leveldata.poki.io/fancade-62036F2322BA7282','965e3740-fb4b-4196-a391-e47a61db1ea5');}
